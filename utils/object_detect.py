...
class ObjectDetect:
    ...
    def start(self):
        # TODO move this part to main program
        ...
        pool = Pool(args.num_workers, self.worker, (input_q, output_q))
        ...
        while self.keep_running:  # fps._numFrames < 120
